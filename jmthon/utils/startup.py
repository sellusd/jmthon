    ...
    if not log_chat:
        ...
        try:
            group_id = await jmubot(
                CreateChannelRequest(
                    title="مجموعة الحفظ لجمثون",
                    about="مجموعة حفظ الأحداث والتنبيهات الخاصة بسورس جمثون\n\n انضم لقناة السورس  ",
                    megagroup=True,
                ),
            )
